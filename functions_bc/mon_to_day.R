...
for (i in 1:dimen[1]){
   for (j in 1:dimen[2]) {
    ...
    m11<-rep(var[i,j,11], each=30); m12<-rep(var[i,j,12], each=31)
      ...
      #days<-c(yr2,yr1,yr1,yr1,yr2,yr1,yr1,yr1,yr2,yr1,yr1,yr1,yr2,yr1,yr1,yr1,yr2,yr1,yr1,yr1,yr2,yr1,yr1,yr1,
        #yr2,yr1,yr1,yr1,yr2,yr1,yr1)  ## previously it was from 80
