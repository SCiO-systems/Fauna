  ...
  for (k in 1:2){ ## 2030 or 2060?
    for (j in 1:4){ ## scenario
      for (i in 1:3){ ### variables tmx, tmin and srad 
        ...
        ## 3. std raw        
        if(n==3 | n==5){
          var_std_f<-nc_open(paste0(dir, 'cc_raw/regrid/future/Ethiopia/',ti[k],'/',var[i],'_Amon_',mod[n],'_ssp',sc[j],'_r1i1p1f1_re_gr_Ethi_monstd_',prd[k],'.nc'))
        } else if (n==4){
          var_std_f<-nc_open(paste0(dir, 'cc_raw/regrid/future/Ethiopia/',ti[k],'/',var[i],'_Amon_',mod[n],'_ssp',sc[j],'_r1i1p1f1_re_gr1_Ethi_monstd_',prd[k],'.nc'))
        } else {
          var_std_f<-nc_open(paste0(dir, 'cc_raw/regrid/future/Ethiopia/',ti[k],'/',var[i],'_Amon_',mod[n],'_ssp',sc[j],'_r1i1p1f1_re_gn_Ethi_monstd_',prd[k],'.nc'))
        }
        ...
        ## 4. historical mean
        if(n==3 | n==5){
          var_h<-nc_open(paste0(dir,'cc_raw/regrid/historical/Ethiopia/monmean/',var[i],'_Amon_',mod[n],'_historical_r1i1p1f1_re_gr_Ethi_monmean_185001-201412.nc'))
        } else if (n==4){
          var_h<-nc_open(paste0(dir,'cc_raw/regrid/historical/Ethiopia/monmean/',var[i],'_Amon_',mod[n],'_historical_r1i1p1f1_re_gr1_Ethi_monmean_185001-201412.nc'))
        } else {
          var_h<-nc_open(paste0(dir,'cc_raw/regrid/historical/Ethiopia/monmean/',var[i],'_Amon_',mod[n],'_historical_r1i1p1f1_re_gn_Ethi_monmean_185001-201412.nc'))
        }     
        ...
        ## 5. std histo
        if(n==3 | n==5){
          var_std_h<-nc_open(paste0(dir,'cc_raw/regrid/historical/Ethiopia/monstd/',var[i],'_Amon_',mod[n],'_historical_r1i1p1f1_re_gr_Ethi_monstd_185001-201412.nc'))
        } else if (n==4){
          var_std_h<-nc_open(paste0(dir,'cc_raw/regrid/historical/Ethiopia/monstd/',var[i],'_Amon_',mod[n],'_historical_r1i1p1f1_re_gr1_Ethi_monstd_185001-201412.nc'))
        } else {
          var_std_h<-nc_open(paste0(dir,'cc_raw/regrid/historical/Ethiopia/monstd/',var[i],'_Amon_',mod[n],'_historical_r1i1p1f1_re_gn_Ethi_monstd_185001-201412.nc'))
        }
        ...
        saveRDS(bias_cor_var, paste0(dir,'cc_bc/Ethiopia/',ti[k],'/',var[i],'_Amon_',mod[n],'_ssp',sc[j],'_',
                                     'r1i1p1f1_re_gn_Ethi_bc_',prd[k],'.RDS'))
      }
    }
  }
}
