...
for (k in 1:2){ ## periods
  for (j in 1:4){ ## scenarios
    ...
    cols=c('#bf812d','#dfc27d','#f6e8c3','#c7eae5','#80cdc1','#35978f','#01665e')
    tit=paste0('Tanzania difference between BC and Raw'," ",pd[k]," ",sc1[j])
    ...
    ggsave(plot = gg, 
           filename = paste0('//dapadfs/workspace_cluster_12/AVISA/data_for_dssat_eaf/plots/diff_bc-raw/precip/ggplot/tanz_ch_precip_bc_raw_',tim[k],'_',sc1[j],'.png'), 
