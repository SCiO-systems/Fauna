...
cdo remapbil,mygrid //dapadfs/workspace_cluster_13/ADAA/CMIP6/raw/${var}_Amon_MIROC6_historical_r1i1p1f1_gn_${ti}.nc ${dir}${var}_Amon_MIROC6_historical_r1i1p1f1_${ti}.nc
