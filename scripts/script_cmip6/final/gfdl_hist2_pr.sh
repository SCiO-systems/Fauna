...
cdo remapcon2,mygrid //dapadfs/workspace_cluster_13/ADAA/CMIP6/raw/${var}_Amon_GFDL-ESM4_historical_r1i1p1f1_gr1_${ti}.nc ${dir}${var}_Amon_GFDL-ESM4_historical_r1i1p1f1_${ti}.nc
