...
cdo remapbil,mygrid //dapadfs/workspace_cluster_13/ADAA/CMIP6/raw/${var}_Amon_${mod}_${sc}_r1i1p1f1_gn_201501-210012.nc ${dir}${var}_Amon_${mod}_${sc}_r1i1p1f1_201501-210012.nc
