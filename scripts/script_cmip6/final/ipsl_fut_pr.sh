...
cdo remapcon2,mygrid //dapadfs/workspace_cluster_13/ADAA/CMIP6/raw/${var}_Amon_IPSL-CM6A-LR_${sc}_r1i1p1f1_gr_201501-210012.nc ${dir}${var}_Amon_IPSL-CM6A-LR_${sc}_r1i1p1f1_201501-210012.nc
