...
cdo remapbil,mygrid //dapadfs/workspace_cluster_13/ADAA/CMIP6/raw/${var}_Amon_${mod}_historical_r1i1p1f1_gr_185001-201412.nc ${dir}${var}_Amon_${mod}_historical_r1i1p1f1_185001-201412.nc
