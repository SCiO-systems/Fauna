...
dif<-mod_av-obs_av  ## differnce between future and present

yld<-abind(obs_av, mod_av, dif, along=3)
...
l<-c(-1000,4000)
b<-seq(-1000,4000,500)
cols=c('#bf812d','#dfc27d','#f7fcfd','#e5f5f9','#ccece6','#99d8c9','#66c2a4','#41ae76','#238b45','#006d2c','#00441b')
