...
ln1<-which(as.character(ln)==33.025);    ln2<-which(as.character(ln)==43.025)
lt1<-which(as.character(lt)==3.025);     lt2<-which(as.character(lt)==13.025) 
...
ug<-readRDS('//dapadfs/workspace_cluster_12/AVISA/data_for_dssat_eaf/dssat_input/Ethiopia_soils_new.RDS')
ug<-ug[1:dim(dd2),]
...
saveRDS(yyy,'//dapadfs/workspace_cluster_12/AVISA/data_for_dssat_eaf/dssat_input/Ethiopia/obs/agMeChrips_ethi_lat4.6_8.9_1991_2010.RDS')
q(save='no')
