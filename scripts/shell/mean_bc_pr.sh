...
cdo timmean ${dir}${cn}/2050/nc/${var}_Amon_${mod}_${sc}_r1i1p1f1_${cn:0:4}_bc_204101-206012.nc ${dir}${cn}/2050/nc/mnmean/${var}_Amon_${mod}_${sc}_r1i1p1f1_${cn:0:4}_bc_204101-206012.climate.nc
done
done
done
done
